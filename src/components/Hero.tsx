  ...
  if (shouldReduceMotion) {
    return (
      <div className="max-w-5xl relative z-20 pointer-events-none mt-10 md:mt-16">
        <div className="font-serif text-4xl sm:text-5xl md:text-[5.5rem] lg:text-[6.5rem] leading-[0.98] tracking-tighter text-zinc-100 mb-8 md:mb-14">
          Arbab <br /> Mujtaba
        </div>
        <div className="mb-10 md:mb-16 space-y-3 lg:ml-3">
          ...
          <div className="font-serif text-lg sm:text-xl md:text-2xl lg:text-3xl leading-[1.1] tracking-tight text-white/90 lg:ml-3">
            Explorer.
          </div>
        </div>
  ...
  return (
    <div className="max-w-5xl relative z-20 pointer-events-none mt-10 md:mt-16">
      <motion.div
        ...
        className="font-serif text-4xl sm:text-5xl md:text-[5.5rem] lg:text-[6.5rem] leading-[0.98] tracking-tighter text-zinc-100 mb-8 md:mb-14"
      >
        Arbab <br /> Mujtaba
      </motion.div>
