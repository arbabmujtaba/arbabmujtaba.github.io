...
/* ------------------------------------------------------------------ */
const SOCIAL_LINKS = {
  github: "YOUR_GITHUB_URL",                  // 👉 e.g. "https://github.com/arbabmujtaba"
  linkedin: "YOUR_LINKEDIN_URL",              // 👉 e.g. "https://www.linkedin.com/in/your-handle"
  instagram: "YOUR_INSTAGRAM_URL",            // 👉 e.g. "https://www.instagram.com/your-handle"
  twitter: "YOUR_TWITTER_URL",                // 👉 e.g. "https://x.com/your-handle"
  readcv: "YOUR_READCV_URL",                  // 👉 e.g. "https://read.cv/your-handle"
  email: "mailto:YOUR_EMAIL@example.com",     // 👉 replace the email after "mailto:"
  phone: "tel:+911234567890",                 // 👉 replace the number after "tel:"
};
